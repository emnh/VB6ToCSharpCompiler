...
{
public class VsAddressOfContext : VB6NodeTranslator
{
    public VsAddressOfContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.VsAddressOfContext;
    }
