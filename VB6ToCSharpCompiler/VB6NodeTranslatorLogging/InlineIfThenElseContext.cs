...
{
public class InlineIfThenElseContext : VB6NodeTranslator
{
    public InlineIfThenElseContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.InlineIfThenElseContext;
    }
