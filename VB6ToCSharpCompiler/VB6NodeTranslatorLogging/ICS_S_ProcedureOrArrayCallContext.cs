...
{
public class ICS_S_ProcedureOrArrayCallContext : VB6NodeTranslator
{
    public ICS_S_ProcedureOrArrayCallContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ICS_S_ProcedureOrArrayCallContext;
    }
