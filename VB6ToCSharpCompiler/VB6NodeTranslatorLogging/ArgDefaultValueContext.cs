...
{
public class ArgDefaultValueContext : VB6NodeTranslator
{
    public ArgDefaultValueContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ArgDefaultValueContext;
    }
