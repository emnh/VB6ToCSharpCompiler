...
{
public class IfElseIfBlockStmtContext : VB6NodeTranslator
{
    public IfElseIfBlockStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.IfElseIfBlockStmtContext;
    }
