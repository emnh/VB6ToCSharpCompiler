...
{
public class LsetStmtContext : VB6NodeTranslator
{
    public LsetStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.LsetStmtContext;
    }
