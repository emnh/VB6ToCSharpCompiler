...
{
public class EnumerationStmtContext : VB6NodeTranslator
{
    public EnumerationStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.EnumerationStmtContext;
    }
