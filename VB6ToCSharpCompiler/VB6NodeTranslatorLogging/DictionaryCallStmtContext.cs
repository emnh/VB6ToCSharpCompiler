...
{
public class DictionaryCallStmtContext : VB6NodeTranslator
{
    public DictionaryCallStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.DictionaryCallStmtContext;
    }
