...
{
public class RedimSubStmtContext : VB6NodeTranslator
{
    public RedimSubStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.RedimSubStmtContext;
    }
