...
{
public class CertainIdentifierContext : VB6NodeTranslator
{
    public CertainIdentifierContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.CertainIdentifierContext;
    }
