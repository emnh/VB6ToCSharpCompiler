...
{
public class ComplexTypeContext : VB6NodeTranslator
{
    public ComplexTypeContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ComplexTypeContext;
    }
