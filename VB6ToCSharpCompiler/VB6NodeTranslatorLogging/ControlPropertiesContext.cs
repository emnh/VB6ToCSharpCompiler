...
{
public class ControlPropertiesContext : VB6NodeTranslator
{
    public ControlPropertiesContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ControlPropertiesContext;
    }
