...
{
public class ECS_MemberProcedureCallContext : VB6NodeTranslator
{
    public ECS_MemberProcedureCallContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ECS_MemberProcedureCallContext;
    }
