...
{
public class ForNextStmtContext : VB6NodeTranslator
{
    public ForNextStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ForNextStmtContext;
    }
