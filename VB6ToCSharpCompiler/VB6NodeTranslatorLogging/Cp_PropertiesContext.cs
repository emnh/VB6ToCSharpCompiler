...
{
public class Cp_PropertiesContext : VB6NodeTranslator
{
    public Cp_PropertiesContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.Cp_PropertiesContext;
    }
