...
{
public class OptionBaseStmtContext : VB6NodeTranslator
{
    public OptionBaseStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.OptionBaseStmtContext;
    }
