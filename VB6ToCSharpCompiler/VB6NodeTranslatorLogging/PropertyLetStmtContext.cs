...
{
public class PropertyLetStmtContext : VB6NodeTranslator
{
    public PropertyLetStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.PropertyLetStmtContext;
    }
