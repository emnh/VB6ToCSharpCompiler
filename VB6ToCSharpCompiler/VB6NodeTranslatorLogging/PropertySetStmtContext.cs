...
{
public class PropertySetStmtContext : VB6NodeTranslator
{
    public PropertySetStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.PropertySetStmtContext;
    }
