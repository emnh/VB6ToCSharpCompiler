...
{
public class ConstSubStmtContext : VB6NodeTranslator
{
    public ConstSubStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ConstSubStmtContext;
    }
