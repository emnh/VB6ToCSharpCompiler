...
{
public class ModuleOptionsContext : VB6NodeTranslator
{
    public ModuleOptionsContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ModuleOptionsContext;
    }
