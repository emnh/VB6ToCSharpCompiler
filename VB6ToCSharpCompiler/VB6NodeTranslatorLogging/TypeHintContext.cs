...
{
public class TypeHintContext : VB6NodeTranslator
{
    public TypeHintContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.TypeHintContext;
    }
