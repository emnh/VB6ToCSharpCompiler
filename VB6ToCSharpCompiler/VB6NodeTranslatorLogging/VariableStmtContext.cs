...
{
public class VariableStmtContext : VB6NodeTranslator
{
    public VariableStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.VariableStmtContext;
    }
