...
{
public class SelectCaseStmtContext : VB6NodeTranslator
{
    public SelectCaseStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.SelectCaseStmtContext;
    }
