...
{
public class ComparisonOperatorContext : VB6NodeTranslator
{
    public ComparisonOperatorContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ComparisonOperatorContext;
    }
