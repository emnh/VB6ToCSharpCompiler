...
{
public class ExplicitCallStmtContext : VB6NodeTranslator
{
    public ExplicitCallStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ExplicitCallStmtContext;
    }
