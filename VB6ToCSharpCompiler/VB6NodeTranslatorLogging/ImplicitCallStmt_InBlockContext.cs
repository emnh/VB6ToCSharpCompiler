...
{
public class ImplicitCallStmt_InBlockContext : VB6NodeTranslator
{
    public ImplicitCallStmt_InBlockContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }
