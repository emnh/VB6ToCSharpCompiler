...
{
public class ICS_B_ProcedureCallContext : VB6NodeTranslator
{
    public ICS_B_ProcedureCallContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ICS_B_ProcedureCallContext;
    }
