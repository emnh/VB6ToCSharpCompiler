...
{
public class AppActivateStmtContext : VB6NodeTranslator
{
    public AppActivateStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.AppActivateStmtContext;
    }
