...
{
public class WhileWendStmtContext : VB6NodeTranslator
{
    public WhileWendStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.WhileWendStmtContext;
    }
