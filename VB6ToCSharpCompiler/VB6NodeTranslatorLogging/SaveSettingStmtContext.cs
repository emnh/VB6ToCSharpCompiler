...
{
public class SaveSettingStmtContext : VB6NodeTranslator
{
    public SaveSettingStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.SaveSettingStmtContext;
    }
