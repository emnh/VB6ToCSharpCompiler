...
{
public class CaseCondExprToContext : VB6NodeTranslator
{
    public CaseCondExprToContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.CaseCondExprToContext;
    }
