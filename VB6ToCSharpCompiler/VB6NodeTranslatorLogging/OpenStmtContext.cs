...
{
public class OpenStmtContext : VB6NodeTranslator
{
    public OpenStmtContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.OpenStmtContext;
    }
