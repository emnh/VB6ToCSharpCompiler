...
{
public class ModuleHeaderContext : VB6NodeTranslator
{
    public ModuleHeaderContext(VB6NodeTree nodeTree, Dictionary<ContextNodeType, VB6NodeTranslator> translatorDict) : base(nodeTree, translatorDict)
    {
    }

    public override ContextNodeType GetNodeContextType()
    {
        return ContextNodeType.ModuleHeaderContext;
    }
